...
export default function WeatherResult({ data, photoData }) {
  ...
  return (
    <div className="min-h-screen flex items-center mx-7 absolute top-0 right-0 left-0">
      <div className="relative text-white w-full md:w-3/4 lg:w-[1000px] h-[600px] mx-auto">
